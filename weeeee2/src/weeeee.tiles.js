...
(function(game){
	...
	us.setup=function(play,sheet)
	{
		...
		for(i=0;i<us.tile_count;i++)
		{
			...
			us.t[i]=gamecake.gfx.sheet({parent:us.sheet,sx:50,sy:240,name:us.tile.s.name,px:i*us.tile_width,py:us.tile.y-us.tile.s.floor}).draw();
			us.t[i].tile=us.tile;
		}
	};
